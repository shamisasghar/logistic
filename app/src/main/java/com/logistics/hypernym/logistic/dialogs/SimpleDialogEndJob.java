package com.logistics.hypernym.logistic.dialogs;
...
public class SimpleDialogEndJob extends Dialog {
    ...
    public SimpleDialogEndJob(Context context, String title, String message, String negativeButtonText, String positiveButtonText, View.OnClickListener onClickListener) {
        super(context);
        this.mTitle = title;
